...
exports.WebUsage = void 0;
const sequelize_1 = require("sequelize");
const sequelize_2 = require("../sequelize");
class WebUsage extends sequelize_1.Model {
}
...
WebUsage.beforeCreate((record, options) => __awaiter(void 0, void 0, void 0, function* () {
    const transaction = options.transaction;
    const last = yield WebUsage.findOne({
        order: [["id", "DESC"]],
        lock: transaction ? transaction.LOCK.UPDATE : false,
        transaction,
    });
    const lastNum = last ? parseInt(last.id.split("-")[1] || "0") : 0;
    record.id = `WU-${String(lastNum + 1).padStart(6, "0")}`;
}));
