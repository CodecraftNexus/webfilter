...
try {
    app.use("/webfilter/api/docs", swagger_ui_express_1.default.serve, swagger_ui_express_1.default.setup(openapi_1.openApiSpec, {
        swaggerOptions: {
...
app.get("/webfilter/health", (req, res) => {
    res.status(200).json({
        success: true,
...
app.use("/webfilter/api/auth", AuthRoute_1.default);
